  ...
  buildDOM(){
    ...
    <div id="scr-help" class="screen hidden">
      <div class="panel help">
        ...
        <p>Im Hauptquartier entstehen Soldaten aus Waffe + Bier (aus der Brauerei):
        ...
        Bogen schlägt Schwert. Münzen aus der Prägerei befördern die Besatzung des
        Militärgebäudes, in dem sie lagern – befördert kämpft es sich besser.</p>
    ...
    if(b.state==='build'){
      ...
      if(b.inv){
        ...
        if(b.type==='hq'){
          ...
          // verbraucht (1 Bier + Waffe -> Rekrut, v224 wie im Vorbild),
          // nicht beim Einzug in den Posten - der zieht fertige Soldaten
          // aus der Reserve. Ohne den Hinweis wirkt der eingefrorene
          // Schwertstapel wie ein Fehler (Nutzer-Report v186/v187), denn
          // die Warnmeldung ist flüchtig, das Lager direkt vor Augen.
