...
export const BLD = {
  ...
  fisher:     { name:'Fischer', cat:'nahrung', size:'S', cost:{board:2}, gather:'fish', out:'fish', range:7, time:90, desc:'Fängt Fische an Gewässern.' },
  ...
  farm:       { name:'Bauernhof', cat:'nahrung', size:'L', cost:{board:3,stone:3}, gather:'farm', out:'grain', range:6, time:70, desc:'Sät und erntet Getreide.' },
